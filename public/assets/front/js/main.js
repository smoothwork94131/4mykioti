        ...
        function resizeHeader() {
            ...
            if(scr_width < 768) {
                ...
                $(".navbar-nav li a").css({
                    ...
                    // "fontSize": (bar_width/orgin_scr_width*16)+"px",
                    // "fontSize": '16px',
                    "textAlign":"left"
                }) ;
                ...
                var logo_header_height = $(".logo-header").height() ;
                // $(".logo-header").css("line-height", logo_header_height+"px") ;
                        ...
                        if (data.categories.length > 0) {
                            ...
                            if (type == 'model') {
                                for (var x in data.categories) {
                                    ...
                                    <div class="categories_title" style="background-color: #e1e1e1" data-type="section"
