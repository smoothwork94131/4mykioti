...
!function (a, b, c, d) {
    ...
    m = {
        ...
        var c, e, g, h, i, j;
        this.state.isTouch && (this.state.isScrolling || (c = a.originalEvent || a || b.event, e = f(c).x, g = f(c).y, this.drag.currentX = e - this.drag.startX, this.drag.currentY = g - this.drag.startY, this.drag.distance = this.drag.currentX - this.drag.offsetX, this.drag.distance < 0 ? this.state.direction = this.settings.rtl ? "right" : "left" : this.drag.distance > 0 && (this.state.direction = this.settings.rtl ? "left" : "right"), this.settings.loop ? this.op(this.drag.currentX, ">", this.coordinates(this.minimum())) && "right" === this.state.direction ? this.drag.currentX -= (this.settings.center && this.coordinates(0)) - this.coordinates(this._items.length) : this.op(this.drag.currentX, "<", this.coordinates(this.maximum())) && "left" === this.state.direction && (this.drag.currentX += (this.settings.center && this.coordinates(0)) - this.coordinates(this._items.length)) : (h = this.coordinates(this.settings.rtl ? this.maximum() : this.minimum()), i = this.coordinates(this.settings.rtl ? this.minimum() : this.maximum()), j = this.settings.pullDrag ? this.drag.distance / 5 : 0, this.drag.currentX = Math.max(Math.min(this.drag.currentX, h + j), i + j)), (this.drag.distance > 8 || this.drag.distance < -8) && (this.state.isSwiping = !0), this.drag.updatedX = this.drag.currentX, (this.drag.currentY > 16 || this.drag.currentY < -16) && this.state.isSwiping === !1 && (this.state.isScrolling = !0, this.drag.updatedX = this.drag.start), this.animate(this.drag.updatedX)))
...
!function (n) {
    ...
    "use strict";
    var t = o(2), a = o(18), r = NaN, i = /^\s+|\s+$/g, s = /^[-+]0x[0-9a-f]+$/i, c = /^0b[01]+$/i, l = /^0o[0-7]+$/i,
        d = parseInt;
    n.exports = function (n) {
    ...
    var t = {
        init: function (n, e) {
            ...
            var n = $(".core-nav-list"), e = n.outerHeight() / 2;
    ...
    var t = {
        init: function (n, e) {
            ...
            var e = $(window).width(), o = $(".core-nav-toggle"), t = o.height() / 2;
            if (e > 920) {
                if (o.css("margin-top", "-" + t + "px"), n.menuFullWidth) {
                    var a = $(".core-nav-list > li").length, r = (e - $(".sidebar-toggle").width()) / a;
    ...
    "use strict";
    var t = o(2), a = o(10), r = o(3), i = "Expected a function", s = Math.max, c = Math.min;
    n.exports = function (n, e, o) {
        var l, d, u, p, v, f, m = 0, w = !1, $ = !1, h = !0;
    ...
    "use strict";
    var t = o(1), a = Object.prototype, r = a.hasOwnProperty, i = a.toString, s = t ? t.toStringTag : void 0;
    n.exports = function (n) {
        var e = r.call(n, s), o = n[s];
        try {
            n[s] = void 0;
            var t = !0
        } catch (n) {
    ...
    "use strict";
    var t = o(1), a = o(14), r = o(13), i = "[object Null]", s = "[object Undefined]", c = t ? t.toStringTag : void 0;
    n.exports = function (n) {
    ...
    var t = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (n) {
        ...
        return n && "function" == typeof Symbol && n.constructor === Symbol && n !== Symbol.prototype ? "symbol" : typeof n
    }, a = o(17), r = o(12), i = "[object Symbol]";
    n.exports = function (n) {
        return "symbol" == (void 0 === n ? "undefined" : t(n)) || r(n) && a(n) == i
    }
}, function (n, e, o) {
    "use strict";
    var t = o(3), a = 1 / 0, r = 1.7976931348623157e308;
    n.exports = function (n) {
    ...
    "use strict";
    var t = o(20), a = "Expected a function";
    ...
    var i = {
        init: function (n, e) {
            ...
            var e = $(".wrap-search-top"), o = e.html();
            ...
            var e = $(".content-header").html(), o = $(window).width();
            ...
            $(".dropdown-overlay").length || $(".core-nav").after('<div class="dropdown-overlay"></div>'), $(e).each(function () {
                var e = $(this), o = $(this).find("a").eq(0), t = $(this).data("width");
            ...
            var n = $(".dropdown").hasClass("open"), e = $(".megamenu").hasClass("open");
            ...
            var e = $(window).width(), o = $(".core-nav .attributes"), t = o.length, a = o.html();
            if (t) {
                ...
                "sidebar" == n.layout && e > 992 && $(".core-nav").prepend('<ul class="attributes">' + a + "</ul>"), e < 992 && ($(".nav-header").prepend('<ul class="attributes">' + a + "</ul>"), $(".wrap-core-nav-list .attributes").remove(), $(".core-nav .attributes").find(".dropdown").each(function () {
                    var n = $(this).width(), e = -1 * $(".dropdown-menu", this).width();
                    $(".dropdown-menu", this).css("marginLeft", e + n)
                }), $(".core-nav .attributes").find(".megamenu").each(function () {
                    var n = $(this).width(), e = -1 * $(".megamenu-content", this).width();
    ...
    "use strict";
    var t, a = u(o(23)), r = u(o(9)), i = u(o(8)), s = u(o(7)), c = u(o(6)), l = u(o(5)), d = u(o(4));
