...
if (isset($_GET['menu_bg_color'])) {
    $menu_bg_color = '#' . $_GET['menu_bg_color'];
} else {
    $menu_bg_color = '#f1f4f7';
}

if (isset($_GET['menu_hover_color'])) {
    $menu_hover_color = '#' . $_GET['menu_hover_color'];
} else {
    $menu_hover_color = '#2b8f03';
}

if (isset($_GET['category_color'])) {
...
.mainmenu-bb {
    background: <?php echo $menu_bg_color; ?>!important;
}
...
.mainmenu-area nav .menu li a:hover {
...
.single-category {
    background: <?php echo $category_color; ?>!important;
}
