(function($) {
    ...
    $(document).ready(function() {
        ...
        $(document).on('change', '#cat', function() {
            ...
            // strain form field add
            var value = $(this).val();

            $("#prod-name input").removeClass("d-none");
            if (value == "16" || value == "17" || value == "18") {
                ...
                $(".prod-name>input").removeClass("d-none");
                $(".prod-name>input").attr('name', 'name');
                $("#strain-search-field").attr('name', 'name-d');

                $(".strain-search").addClass("d-none");
                $(".prod-effect").addClass("d-none");
                $(".prod-parent").addClass("d-none");
            }

            $("[name=name-d]").prop('required', false);
            //flower, genetics, or concentrates
            ...
            $.get(getattrUrl + '?id=' + this.value + '&type=category', function(data) {
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    <div class="col-lg-7">
                        <ul class="list">
                            <li>
                                <input class="checkclick2" name="${data[i].attribute.input_name}_check" type="checkbox" id="${data[i].attribute.input_name}_check" value="1">
                                <label for="${data[i].attribute.input_name}_check">Allow Product ${data[i].attribute.name}</label>
                            </li>
                        </ul>
                    </div>
                </div>`;
