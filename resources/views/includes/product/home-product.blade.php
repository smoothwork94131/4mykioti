...
@if ($prod->vendorPrice() <= $_GET['max']) <div class="col-lg-4 col-md-4 col-6 remove-padding">
    ...
    <a href="{{ route('front.homeproduct', $prod->slug) }}" class="item">
        <div class="item-img">
            ...
            <img class="img-fluid" style="max-width:125px; max-height: 150px;" src="{{ $prod->thumbnail ? asset('assets/images/thumbnails/' . $prod->thumbnail) : asset('assets/images/products/' . $gs->prod_image) }}" alt="">
        </div>
        <div class="info">
            <div class="stars">
                <div class="ratings">
