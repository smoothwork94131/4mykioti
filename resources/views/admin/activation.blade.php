                                        ...
                                        <div class="col-lg-4">
                                            <div class="left-area">
                                                ...
                                                <p class="sub-heading"><a
                                                            ...
                                                            target="_blank">{{ __('How to get purchase code?') }}</a>
                                                </p>
                                            </div>
                                        </div>
                                        <div class="col-lg-7">
                                            <input class="form-control" name="pcode" id="admin_name"
                                                   placeholder="{{ __('Enter Purchase Code') }}" required="" value=""
                                                   type="text">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7">
                                            <button class="addProductSubmit-btn"
                                                    type="submit">{{ __('Activate') }}</button>
                                        </div>
                                    </div>
