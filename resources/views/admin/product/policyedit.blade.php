            ...
            <div class="col-lg-12">
                <div class="product-description">
                    <div class="body-area">
                        ...
                        <form id="geniusform" action="{{route('admin-prod-policy-update',$data->id)}}" method="POST">
                            {{csrf_field()}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-7 prod-name">
                                    <input type="text" class="input-field" value="{{ $data->name }}" placeholder="{{ __('Enter Policy Name') }}" name="name" required="">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-7 text-center">
                                    <button class="addProductSubmit-btn" type="submit">{{ __('Update Product Policy')}}</button>
                                </div>
                            </div>
                        </form>
                    </div>
