...
@section('scripts')
    <script>
        ...
        $(document).on('click', '.remove-img', function () {
            ...
            $.ajax({
                type: "post",
                url: "{{ route('admin-strain-gallery-remove') }}",
                data: {
                        ...
                        if (data != 0) {
                            ...
                            for (var i = 0; i < data.length; i++) {
                                var html = '<div class="col-sm-2">' +
                                    ...
                                    '</span>' +
                                    '<a href="' + base_url + '/' + data[i].path + '" id="href_id_' + data[i].id + '" target="_blank">' +
                                    '<img src="' + base_url + '/' + data[i].path + '" alt="gallery image">' +
                                    '</a>' +
                                    '</div>' +
                                    '<div class="custom-control custom-radio text-center">' +
                                    '<input type="radio" class="custom-control-input" id="main_logo_' + data[i].id + '" name="main_logo" value="' + data[i].id + '">' +
                                    '<label class="custom-control-label" for="main_logo_' + data[i].id + '">Strain Main Gallery</label>' +
                                    '</div>' +
                                    '</div>';

                                $('.selected-image .row').append(html);
                            }
                        }
                    }
                });
