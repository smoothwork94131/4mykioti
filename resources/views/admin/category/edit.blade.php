                            ...
                            <form id="geniusformdata" action="{{route('admin-cat-update',$data->id)}}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <ul class="list">
                                            <li>
                                                <input name="skip_license" type="checkbox" id="skip_license" value="1" @if($data->skip_license) checked @endif>
                                                <label for="skip_license">Skip License</label>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field" name="order"
                                               placeholder="{{ __('Enter Order') }}" required="" value="{{$data->order}}">
                                    </div>
                                </div>
