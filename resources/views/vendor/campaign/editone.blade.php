            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="links">
                        ...
                        <li>
                            <a href="{{ route('vendor-campaign-edit', array('id' => $data->id)) }}">{{ __("Edit Campaign Option") }}</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="product-description">
                        <div class="body-area">
                            ...
                            <form id="geniusform" action="{{route('vendor-campaign-update', $data->id)}}" method="POST" enctype="multipart/form-data">
                                {{csrf_field()}}
