                    ...
                    <div class="user-profile-details">
                        <div class="order-history">
                            <div class="header-area">
                                <h4 class="title">
                                    {{ $langg->lang378 }} <a data-toggle="modal" data-target="#vendorform"
                                                             class="mybtn1" href="javascript:;"> <i
                                                class="fas fa-envelope"></i> {{ $langg->lang379 }}</a>
                                </h4>
                            </div>
                                            ...
                                            <ul>
                                                <li>
                                                    <input type="text" class="input-field" id="order"
                                                           name="order_numkber" placeholder="{{ $langg->lang386 }} *"
                                                           required="">
                                                </li>
