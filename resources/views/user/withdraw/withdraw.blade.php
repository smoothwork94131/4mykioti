                    ...
                    <div class="user-profile-details">
                        <div class="order-history">
                            <div class="header-area">
                                <h4 class="title">
                                    {{ $langg->lang336 }}
                                    <a class="mybtn1" href="{{route('user-wwt-index')}}"> <i
                                                class="fas fa-arrow-left"></i> {{ $langg->lang337 }}</a>
                                </h4>
                            </div>
                            ...
                            <form id="userform" class="form-horizontal" action="{{route('user-wwt-store')}}"
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-12"
                                           for="name">{{ $langg->lang355 }} {{ App\Models\Product::vendorConvertPrice(Auth::user()->affilate_income) }}</label>
                                </div>
                                ...
                                <div id="paypal" style="display: none;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input name="acc_email" placeholder="{{ $langg->lang345 }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input name="iban" value="{{ old('iban') }}"
                                                   placeholder="{{ $langg->lang346 }}" class="form-control" type="text">
                                        </div>
                                    </div>
