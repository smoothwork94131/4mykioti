                            ...
                            <ul class="list">
                                ...
                                <li class="bell-area">
                                    <a id="notf_conv" class="dropdown-toggle-1" href="javascript:;">
                                        ...
                                        <span data-href="{{ route('conv-notf-count') }}" id="conv-notf-count">{{
                                            App\Models\Notification::countConversation() }}</span>
                                    </a>
                                ...
                                <li class="bell-area">
                                    <a id="notf_product" class="dropdown-toggle-1" href="javascript:;">
                                        ...
                                        <span data-href="{{ route('product-notf-count') }}" id="product-notf-count">{{
                                ...
                                <li class="bell-area">
                                    <a id="notf_user" class="dropdown-toggle-1" href="javascript:;">
                                        ...
                                        <span data-href="{{ route('user-notf-count') }}" id="user-notf-count">{{
                                ...
                                <li class="bell-area">
                                    <a id="notf_order" class="dropdown-toggle-1" href="javascript:;">
                                        ...
                                        <span data-href="{{ route('order-notf-count') }}" id="order-notf-count">{{
