                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-primary">
                                                @if(Auth::guard('web')->check())
                                                    <span class="dropdown-item add-to-wish" data-href="{{ route('user-wishlist-add', ['series' => strtolower($slug_list["series"]), 'prod_id' => $item->id]) }}"><i class="icofont-heart-alt"></i>&nbsp;&nbsp;Add to Wish</span>
                                                @else
                                                ...
                                                @endif
                                                <span class="dropdown-item quick-view" data-href="{{ route('product.iquick',['db' => strtolower($slug_list["series"]), 'id' => $item->id]) }}" data-toggle="modal" data-target="#quickview"><i class="icofont-eye"></i>&nbsp;&nbsp;Quick View</span>
                                                <span class="dropdown-item add-to-cart add-to-cart-btn" data-href="{{ route('product.cart.add',['db' => strtolower($slug_list["series"]), 'id' => $item->id]) }}"><i class="icofont-cart"></i>&nbsp;&nbsp;{{ $langg->lang56 }}</span>
                                                <span class="dropdown-item add-to-cart-quick" style="width: 100%;" data-href="{{ route('product.cart.quickadd',['db' => strtolower($slug_list["series"]), 'id' => $item->id]) }}"><i class="icofont-dollar"></i>&nbsp;&nbsp;{{ $langg->lang251 }}</span>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
