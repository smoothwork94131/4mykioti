                ...
                <div class="row">
                    <div class="col-lg-5 col-md-12">
                        <div class="xzoom-container">
                            <img class="xzoom5" id="xzoom-magnific" src="{{ filter_var($productt->photo, FILTER_VALIDATE_URL) ? $productt->photo : ($productt->photo ? asset('assets/images/products/' . $productt->photo) : asset('assets/images/products/' . $gs->prod_image)) }}" xoriginal="{{ filter_var($productt->photo, FILTER_VALIDATE_URL) ? $productt->photo : ($productt->photo ? asset('assets/images/products/' . $productt->photo) : asset('assets/images/products/' . $gs->prod_image)) }}" />
                        ...
                        <div class="item-slide">
                            <ul class="item-list">
                                @foreach ($chunk as $prod)
                                    @include('includes.product.list-product', ['flag'=>'prod', 'slug_list' => $slug_list])
                                @endforeach
                            </ul>
                        </div>
                        @endforeach
