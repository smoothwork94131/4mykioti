<div class="item-filter" style="display:flex; align-items: center; justify-content: space-between; width: 40%;">
    <p style="width: inherit; margin-bottom: 5px;">{{$langg->lang64}} :</p>
