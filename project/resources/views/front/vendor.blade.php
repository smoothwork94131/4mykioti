            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul class="pages">
                        ...
                        <li>
                            <a href="{{route('front.vendor', str_replace(' ', '-', $vendor->shop_name))}}">{{ $vendor->shop_name }}</a>
                        </li>
                        @if (!empty($cat))
                            <li>
                                <a href="{{route('front.vendor', [str_replace(' ', '-', $vendor->shop_name), $cat->slug])}}">{{ $cat->name }}</a>
                            </li>
                        @endif
                        @if (!empty($subcat))
                            <li>
                                <a href="{{route('front.vendor', [str_replace(' ', '-', $vendor->shop_name), $cat->slug, $subcat->slug])}}">{{ $subcat->name }}</a>
                            </li>
                        @endif
                        @if (!empty($childcat))
                            <li>
                                <a href="{{route('front.vendor', [str_replace(' ', '-', $vendor->shop_name), $cat->slug, $subcat->slug, $childcat->slug])}}">{{ $childcat->name }}</a>
                            </li>
                        @endif
