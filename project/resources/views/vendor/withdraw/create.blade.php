...
@section('content')
    ...
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ $langg->lang479 }} <a class="add-btn" href="{{ url()->previous() }}"><i
                                    class="fas fa-arrow-left"></i> {{ $langg->lang480 }}</a></h4>
                    <ul class="links">
                        <li>
                        ...
                        <div class="body-area">
                            ...
                            <form id="geniusform" class="form-horizontal" action="{{route('vendor-wt-store')}}"
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-sm-12" for="name"><b>{{ $langg->lang498 }}
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input name="amount" placeholder="{{ $langg->lang487 }}" class="form-control"
                                ...
                                <div id="paypal" style="display: none;">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input name="acc_email" placeholder="{{ $langg->lang488 }}"
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input name="iban" value="{{ old('iban') }}"
                                                   placeholder="{{ $langg->lang489 }}" class="form-control" type="text">
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input name="acc_name" value="{{ old('accname') }}"
                                                   placeholder="{{ $langg->lang490 }}" class="form-control" type="text">
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input name="address" value="{{ old('address') }}"
                                                   placeholder="{{ $langg->lang491 }}" class="form-control" type="text">
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input name="swift" value="{{ old('swift') }}"
                                                   placeholder="{{ $langg->lang492 }}" class="form-control" type="text">
                                        </div>
                                    </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <textarea class="form-control" name="reference" rows="6"
                                                  placeholder="{{ $langg->lang493 }}">{{ old('reference') }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="add-product-footer">
                                    <button name="addProduct_btn" type="submit"
                                            class="mybtn1">{{ $langg->lang497 }}</button>
                                </div>
                            </form>
