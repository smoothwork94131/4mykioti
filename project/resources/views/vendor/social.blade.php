        ...
        <div class="social-links-area">
            ...
            <form id="geniusform" class="form-horizontal" action="{{ route('vendor-social-update') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <input class="form-control" name="f_url" id="facebook" placeholder="{{ $langg->lang526 }}"
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <input class="form-control" name="g_url" id="gplus" placeholder="{{ $langg->lang527 }}"
                               required="" type="text" value="{{$data->g_url}}">
                    </div>
                    <div class="col-sm-3">
                        <label class="switch">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <input class="form-control" name="t_url" id="twitter" placeholder="{{ $langg->lang528 }}"
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <input class="form-control" name="l_url" id="linkedin" placeholder="{{ $langg->lang529 }}"
