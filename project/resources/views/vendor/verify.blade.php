                                ...
                                <form id="verifyform" action="{{route('vendor-verify-submit')}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <a href="javascript:;" id="attachment-btn" class="add-more mt-4">
                                                <i class="fas fa-plus"></i>{{ __('Add More Attachment') }} 
                                            </a>
                                        </div>
                                    </div>
