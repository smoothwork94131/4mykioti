 ...
 *//*! normalize.css v3.0.3 | MIT License | github.com/necolas/normalize.css */
        ...
        * {
        ...
        .table.top-reference, .table.os-table {
            margin-top: 10px;
            margin-bottom: 0;
        }
        ...
        .qualification-area, .color-area, .single-color .qualification-area-open {
            position: relative;
        }
        ...
        .profile-wishlist a, .profile-notifi a, .profile-comments a {
            position: relative;
        }
