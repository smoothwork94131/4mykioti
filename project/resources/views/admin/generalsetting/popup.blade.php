                        ...
                        <div class="body-area">
                            ...
                            <form action="{{ route('admin-gs-update') }}" id="geniusform" method="POST"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="action-list">
                                            <select class="process select droplinks {{ $gs->is_popup  == 1 ? 'drop-success' : 'drop-danger' }}">
                                                <option data-val="1"
                                                        value="{{route('admin-gs-ispopup',1)}}" {{ $gs->is_popup == 1 ? 'selected' : '' }}>{{ __('Activated') }}</option>
                                                <option data-val="0"
                                                        value="{{route('admin-gs-ispopup',0)}}" {{ $gs->is_popup == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="input-field" placeholder="{{ __('Popup Title') }}"
                                               name="popup_title" value="{{ $gs->popup_title }}" required="">
                                    </div>
                                </div>
