            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="links">
                        ...
                        <li>
                            <a href="{{ route('admin-strain-edit', array('id' => $data->id)) }}">{{ __("Edit Strain") }}</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="product-description">
                        <div class="body-area">
                            ...
                            <form id="geniusform" action="{{route('admin-strain-update', $data->id)}}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <textarea rows="5"  class="form-control" name="effect">{{ $data->effect }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <textarea rows="5"  class="form-control" name="parent">{{ $data->parent }}</textarea>
                                    </div>
                                </div>
