                ...
                <div class="col-lg-12">
                    <div class="product-description">
                        <div class="body-area">
                            ...
                            <form id="geniusform" action="{{route('admin-strain-store')}}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <textarea rows="5" class="form-control" name="effect"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <textarea rows="5" class="form-control" name="parent"></textarea>
                                    </div>
                                </div>
