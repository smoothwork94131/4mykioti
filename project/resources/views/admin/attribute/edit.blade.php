                ...
                <div class="col-lg-12">
                    <h4 class="heading d-inline-block">
                        ...
                        <a href="{{ url()->previous() }}" class="add-btn"><i
                                    class="fas fa-angle-left"></i> {{__('Back')}}</a>
                    </h4>
                        ...
                        <div class="add-product-content">
                            <div class="row">
                                <div class="col-md-6 offset-md-3">
                                    ...
                                    <form id="geniusform" action="{{route('admin-attr-update', $attr->id)}}"
                                                    ...
                                                    <div class="row mb-2 counterrow" v-for="option in options"
                                                        ...
                                                        <div class="col-md-11">
                                                            <input class="input-field optionin" type="text"
                                                                   name="options[]" :value="option.name"
                                        ...
                                        <div class="row mb-4">
                                            <div class="col-lg-12">
                                                <div class="custom-control custom-checkbox">
                                                    ...
                                                    <label class="custom-control-label" for="detailsStatus1">Show on
                                                        Details Page</label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="text-left">
                                            <button type="submit"
                                                    class="btn btn-primary addProductSubmit-btn">{{__('UPDATE FIELD')}}</button>
                                        </div>
                                    </form>
