                                                    ...
                                                    <div class="col-lg-9">
                                                        @foreach ($attribute->attribute_options as $key => $option)
                                                            <div class="custom-control custom-radio custom-control-inline">
                                                                <input type="radio"
                                                                       id="customRadioInline{{$option->id}}"
                                                                       name="{{ $attribute->id }}"
                                                                       class="custom-control-input">
                                                                <label class="custom-control-label"
                                                                       for="customRadioInline{{$option->id}}">{{ $option->name }}</label>
                                                            </div>
                                                        @endforeach
                                                    </div>
                                                </div>
                                    ...
                                    @foreach ($data->attributes as $key => $attribute)
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                @foreach ($attribute->attribute_options as $key => $option)
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" id="customRadioInline{{$option->id}}"
                                                               name="{{ $attribute->id }}" class="custom-control-input">
                                                        <label class="custom-control-label"
                                                               for="customRadioInline{{$option->id}}">{{ $option->name }}</label>
                                                    </div>
                                                @endforeach
                                            ...
                                            <div class="col-md-3">
                                                <a href="{{route('admin-attr-edit', $attribute->id)}}"
                                                   class="btn btn-warning"><i class="fas fa-edit"></i></a>
                                                <form class="d-inline-block"
                                                      action="{{ route('admin-attr-delete', $attribute->id) }}"
                                                      method="get">
                                                    <button type="submit" class="btn btn-danger"
                                                            data-target="#confirm-delete" data-toggle="modal"><i
