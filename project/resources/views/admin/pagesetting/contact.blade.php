                        ...
                        <div class="body-area">
                            ...
                            <form id="geniusform" action="{{ route('admin-ps-update') }}" method="POST"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="action-list">
                                            <select class="process select droplinks {{ $gs->is_contact == 1 ? 'drop-success' : 'drop-danger' }}">
                                                <option data-val="1"
                                                        value="{{route('admin-gs-iscontact',1)}}" {{ $gs->is_contact == 1 ? 'selected' : '' }}>{{ __('Activated') }}</option>
                                                <option data-val="0"
                                                        value="{{route('admin-gs-iscontact',0)}}" {{ $gs->is_contact == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="tawk-area">
                                            <textarea class="nic-edit"
                                                      name="contact_title"> {{ $data->contact_title }} </textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="tawk-area">
                                            <textarea class="nic-edit"
                                                      name="contact_text"> {{ $data->contact_text }} </textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="input-field" placeholder="{{ __('Enter Website') }}"
                                               name="site" value="{{ $data->site }}">
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="tawk-area">
                                            <textarea name="street"
                                                      placeholder="Enter Street Address"> {{ $data->street }} </textarea>
                                        </div>
                                    </div>
                                </div>
