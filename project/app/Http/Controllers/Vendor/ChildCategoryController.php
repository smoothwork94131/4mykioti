...
class ChildCategoryController extends Controller
{
    ...
    {
        $user = Auth::user();
        $datas = $user->childcategories()->orderBy('id', 'desc')->get();
    ...
    public function store(Request $request)
    {
        ...
        //---- validate childcategory name unique.
        $childcategories = $data->where("subcategory_id", $input['subcategory_id'])->get();
        $check_unique = true;
        foreach ($childcategories as $childcat) {
            if ($childcat->name == $input['name']) {
                $check_unique = false;
            }
        }

        if (!$check_unique) {
            $message = "The child category name have been used.";
            return response()->json(array('errors' => [$message]));
        }
        //---- end validate childcategory name unique.
        ...
        return response()->json(array(
            'flag' => 'ok',
            'route' => route('vendor-childcat-index')
        ));
    ...
    public function update(Request $request, $id)
    {
        ...
        $childcategories = $childcat->where("subcategory_id", $input['subcategory_id'])->get();
        $check_unique = true;
