                    ...
                    <div class="special-box">
                        ...
                        <form class="uplogo-form" id="geniusform" action="<?php echo e(route('admin-gs-update')); ?>" method="POST"
                            ...
                            <div class="loader-switcher">
                                ...
                                <div class="action-list">
                                    <select class="process select droplinks <?php echo e($gs->is_loader == 1 ? 'drop-success' : 'drop-danger'); ?>">
                                        <option data-val="1"
                                                value="<?php echo e(route('admin-gs-isloader',1)); ?>" <?php echo e($gs->is_loader == 1 ? 'selected' : ''); ?>><?php echo e(__('Activated')); ?></option>
                                        <option data-val="0"
                                                value="<?php echo e(route('admin-gs-isloader',0)); ?>" <?php echo e($gs->is_loader == 0 ? 'selected' : ''); ?>><?php echo e(__('Deactivated')); ?></option>
                                    </select>
                                </div>
                            </div>
                            <div class="currrent-logo">
                                ...
                                <img src="<?php echo e($gs->loader ? asset('assets/images/'.$gs->loader):asset('assets/images/noimage.png')); ?>"
                                     alt="">
                            </div>
                            <div class="set-logo">
                                <h4 class="title">
                    ...
                    <div class="special-box">
                        ...
                        <form class="uplogo-form" id="geniusform" action="<?php echo e(route('admin-gs-update')); ?>" method="POST"
                            ...
                            <div class="loader-switcher">
                                ...
                                <div class="action-list">
                                    <select class="process select droplinks <?php echo e($gs->is_admin_loader == 1 ? 'drop-success' : 'drop-danger'); ?>">
                                        <option data-val="1"
                                                value="<?php echo e(route('admin-gs-is-admin-loader',1)); ?>" <?php echo e($gs->is_admin_loader == 1 ? 'selected' : ''); ?>><?php echo e(__('Activated')); ?></option>
                                        <option data-val="0"
                                                value="<?php echo e(route('admin-gs-is-admin-loader',0)); ?>" <?php echo e($gs->is_admin_loader == 0 ? 'selected' : ''); ?>><?php echo e(__('Deactivated')); ?></option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="currrent-logo">
                                ...
                                <img src="<?php echo e($gs->admin_loader ? asset('assets/images/'.$gs->admin_loader):asset('assets/images/noimage.png')); ?>"
                                     alt="">
                            </div>
