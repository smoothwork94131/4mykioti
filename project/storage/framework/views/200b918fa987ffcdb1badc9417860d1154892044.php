                        ...
                        <div class="cart-table">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <th class="d-desktop"><?php echo e($langg->lang125); ?></th>
                                    <th class="d-mobile">Price</th>
                                    <th class="d-desktop"><?php echo e($langg->lang126); ?></th>
                                ...
                                <?php if(Session::has('cart')): ?>
                                    ...
                                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="cremove<?php echo e(($product['db']??'products').$product['item']->id.$product['size'].$product['color'].str_replace(str_split(' ,'),'',$product['values'])); ?>">
                                            <td class="product-img">
                                                <div class="item">
                                                    <img src="<?php echo e($product['item']->photo ? asset('assets/images/products/'.$product['item']->photo):asset('assets/images/noimage.png')); ?>"
                                                         alt="">
                                                    <p class="name"><a
                                                                href="<?php echo e(route('front.product', $product['item']->slug)); ?>"><?php echo e(mb_strlen($product['item']->name,'utf-8') > 35 ? mb_substr($product['item']->name,0,35,'utf-8').'...' : $product['item']->name); ?></a>
                                                    </p>
                                                </div>
                                            </td>
                                            <!-- <td>
                                                <?php if(!empty($product['size'])): ?>
                                                    ...
                                                    : <?php echo e($product['item']->measure); ?><?php echo e(str_replace('-',' ',$product['size'])); ?>

                                                    <br>
                                                <?php endif; ?>
                                                <?php if(!empty($product['color'])): ?>
                                                    <div class="d-flex mt-2">
                                                        <b><?php echo e($langg->lang313); ?></b>: <span id="color-bar"
                                                    ...
                                                    <div class="qty">
                                                        <ul>
                                                            <input type="hidden" class="db"
                                                                   value="<?php echo e($product['db']??'products'); ?>">    
                                                            <input type="hidden" class="prodid"
                                                                   value="<?php echo e($product['item']->id); ?>">
                                                            <input type="hidden" class="itemid"
                                                                   value="<?php echo e(($product['db']??'products').$product['item']->id.$product['size'].$product['color'].str_replace(str_split(' ,'),'',$product['values'])); ?>">
                                                            <input type="hidden" class="size_qty"
                                                                   value="<?php echo e($product['size_qty']); ?>">
                                                            <input type="hidden" class="size_price"
                                                                   value="<?php echo e($product['item']->price); ?>">
                                                            <li>
                                  <span class="qtminus1 reducing">
                                    <i class="icofont-minus"></i>
                                                            ...
                                                            <li>
                                                                <span class="qttotal1"
                                                                      id="qty<?php echo e(($product['db']??'products').$product['item']->id.$product['size'].$product['color'].str_replace(str_split(' ,'),'',$product['values'])); ?>"><?php echo e($product['qty']); ?></span>
                                                            </li>
                                                            <li>
                                  <span class="qtplus1 adding">
                                    <i class="icofont-plus"></i>
                                                ...
                                                <br>
                                                <div class="d-mobile">
                                                    <p id="prc<?php echo e(($product['db']??'products').$product['item']->id.$product['size'].$product['color'].str_replace(str_split(' ,'),'',$product['values'])); ?>">
                                                        <?php echo e(App\Models\Product::convertPrice($product['price'])); ?>

                                                    </p>

                                                    <span class="removecart cart-remove"
                                                        data-class="cremove<?php echo e(($product['db']??'products').$product['item']->id.$product['size'].$product['color'].str_replace(str_split(' ,'),'',$product['values'])); ?>"
                                                        data-href="<?php echo e(route('product.cart.remove', ($product['db']??'products').$product['item']->id.$product['size'].$product['color'].str_replace(str_split(' ,'),'',$product['values']))); ?>"><i
                                            ...
                                            <?php if($product['size_qty']): ?>
                                                <input type="hidden"
                                                       id="stock<?php echo e(($product['db']??'products').$product['item']->id.$product['size'].$product['color'].str_replace(str_split(' ,'),'',$product['values'])); ?>"
                                                       value="<?php echo e($product['size_qty']); ?>">
                                    ...
                                    <li>
                                        ...
                                        <P>
                                            ...
                                            <input type="hidden" id="d-val"
                                                   value="<?php echo e(App\Models\Product::convertPrice(0)); ?>">
                                        </P>
                                    </li>
                                    <li>
                                        <p>
