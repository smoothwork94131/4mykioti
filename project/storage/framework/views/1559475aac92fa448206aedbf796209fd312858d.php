                    ...
                    <div class="special-box bg-gray">
                        ...
                        <form class="uplogo-form" id="geniusform" action="<?php echo e(route('admin-gs-update')); ?>" method="POST"
                            ...
                            <div class="currrent-logo">
                                <img src="<?php echo e($gs->logo ? asset('assets/images/'.$gs->logo):asset('assets/images/noimage.png')); ?>"
                                     alt="">
                            </div>
                            <div class="set-logo">
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="special-box  bg-gray">
                        ...
                        <form class="uplogo-form" id="geniusform" action="<?php echo e(route('admin-gs-update')); ?>" method="POST"
                            ...
                            <?php echo $__env->make('includes.admin.form-both', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            <div class="currrent-logo">
                                <img src="<?php echo e($gs->footer_logo ? asset('assets/images/'.$gs->footer_logo):asset('assets/images/noimage.png')); ?>"
                                     alt="">
                            </div>
                            <div class="set-logo">
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="special-box  bg-gray">
                        ...
                        <form class="uplogo-form" id="geniusform" action="<?php echo e(route('admin-gs-update')); ?>" method="POST"
                            ...
                            <div class="currrent-logo">
                                <img src="<?php echo e($gs->invoice_logo ? asset('assets/images/'.$gs->invoice_logo):asset('assets/images/noimage.png')); ?>"
                                     alt="">
                            </div>
