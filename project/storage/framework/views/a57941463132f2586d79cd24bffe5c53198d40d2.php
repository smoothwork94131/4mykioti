                                                            ...
                                                            <div class="billing-add-area">
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <address>
                                                                            <?php echo e($langg->lang288); ?> <?php echo e($order->customer_name); ?>

                                                                            <br>
                                                                            <?php echo e($langg->lang289); ?> <?php echo e($order->customer_email); ?>

                                                                            <br>
                                                                            <?php echo e($langg->lang290); ?> <?php echo e($order->customer_phone); ?>

                                                                            <br>
                                                                            <?php echo e($langg->lang291); ?> <?php echo e($order->customer_address); ?>

                                                                            <br>
                                                                            <?php echo e($order->customer_city); ?>

                                                                            -<?php echo e($order->customer_zip); ?>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <?php if($order->method != "Cash On Delivery"): ?>
                                                                            <?php if($order->method=="Stripe"): ?>
                                                                                <?php echo e($order->method); ?> <?php echo e($langg->lang295); ?>

                                                                                <p><?php echo e($order->charge_id); ?></p>
                                                                            <?php endif; ?>
                                                                            <?php echo e($order->method); ?> <?php echo e($langg->lang296); ?> <p
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <?php if($order->shipping == "shipto"): ?>
                                                                            ...
                                                                            <address>
                                                                                <?php echo e($langg->lang288); ?> <?php echo e($order->shipping_name == null ? $order->customer_name : $order->shipping_name); ?>

                                                                                <br>
                                                                                <?php echo e($langg->lang289); ?> <?php echo e($order->shipping_email == null ? $order->customer_email : $order->shipping_email); ?>

                                                                                <br>
                                                                                <?php echo e($langg->lang290); ?> <?php echo e($order->shipping_phone == null ? $order->customer_phone : $order->shipping_phone); ?>

                                                                                <br>
                                                                                <?php echo e($langg->lang291); ?> <?php echo e($order->shipping_address == null ? $order->customer_address : $order->shipping_address); ?>

                                                                                <br>
                                                                                <?php echo e($order->shipping_city == null ? $order->customer_city : $order->shipping_city); ?>
                                                                        ...
                                                                        <?php else: ?>
                                                                            ...
                                                                            <address>
                                                                                <?php echo e($langg->lang304); ?> <?php echo e($order->pickup_location); ?>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <?php if($order->shipping_cost != 0): ?>
                                                                            ...
                                                                            <?php if(DB::table('shippings')->where('price','=',$price)->count() > 0): ?>
                                                                                <p>
                                                                                    <?php echo e(DB::table('shippings')->where('price','=',$price)->first()->title); ?>

                                                                                    : <?php echo e($order->currency_sign); ?><?php echo e(round($order->shipping_cost, 2)); ?>
                                                                        ...
                                                                        <?php if($order->packing_cost != 0): ?>
                                                                            ...
                                                                            <?php if(DB::table('packages')->where('price','=',$pprice)->count() > 0): ?>
                                                                                <p>
                                                                                    <?php echo e(DB::table('packages')->where('price','=',$pprice)->first()->title); ?>

                                                                                    : <?php echo e($order->currency_sign); ?><?php echo e(round($order->packing_cost, 2)); ?>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <?php if($order->method != "Cash On Delivery"): ?>
                                                                            ...
                                                                            <?php if($order->method=="Paypal"): ?>
                                                                                <?php echo e($order->method); ?> <?php echo e($langg->lang296); ?>

                                                                                <p id="ttn"><?php echo e(isset($_GET['tx']) ? $_GET['tx'] : ''); ?></p>
                                                                            <?php else: ?>
                                                                                <?php echo e($order->method); ?> <?php echo e($langg->lang296); ?>
        ...
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="alert alert-primary fade show"
                                                    ...
                                                    <a href="<?php echo e(route('front.index')); ?>" type="button" class="btn btn-primary">
