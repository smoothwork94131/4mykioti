<div class="col-lg-3 col-md-6 remove-padding">
    <div class="left-area">
                ...
                <form id="catalogForm"
                    ...
                    <ul class="filter-list">
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li>
                                <div class="content">
                                    <a href="<?php echo e(route('front.category', $element->slug)); ?><?php echo e(!empty(request()->input('search')) ? '?search='.request()->input('search') : ''); ?>"
                                       class="category-link"> <i
                                                class="fas fa-angle-double-right"></i> <?php echo e($element->name); ?></a>
