                            ...
                            <form id="geniusform" action="<?php echo e(route('admin-prod-update',$data->id)); ?>" method="POST"
                                        ...
                                        <select id="cat" name="category_id" required="">
                                            ...
                                            <?php $__currentLoopData = $cats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option data-href="<?php echo e(route('admin-subcat-load',$cat->id)); ?>"
                                                        value="<?php echo e($cat->id); ?>" <?php echo e($cat->id == $data->category_id ? "selected":""); ?> ><?php echo e($cat->name); ?></option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 prod-name">
                                        <input type="text" class="input-field" placeholder="<?php echo e(__('Enter Product Name')); ?>" value="<?php echo e($data->name); ?>" name="name" required="">
                                        <div class="strain-search d-none">
                                        
                                            <input type="text" data-href="<?php echo e(route('admin-strain-search')); ?>" id="strain-search-field" class="input-field" placeholder="<?php echo e(__('Enter Product Name')); ?>" value="<?php echo e($data->name); ?>" name="name-d" required="">
                                    ...
                                    <div class="col-lg-7">
                                        ...
                                        <div class="checkbox-wrapper">
                                            <input type="checkbox" name="product_condition_check" class="checkclick"
                                                   id="conditionCheck"
                                                   value="1" <?php echo e($data->product_condition != 0 ? "checked":""); ?>>
                                ...
                                <?php $__currentLoopData = $locs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option data-href="<?php echo e(route('admin-policy-load', $loc->id)); ?>" value="<?php echo e($loc->id); ?>" <?php echo e($loc->id == $data->location_id ? "selected":""); ?> ><?php echo e($loc->address); ?> <?php echo e($loc->state); ?> (<?php echo e($loc->location_name); ?>)</option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-7">
                                        <select id="subcat" name="subcategory_id">
                                            ...
                                            <?php else: ?>
                                                <?php $__currentLoopData = $data->category->subs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option data-href="<?php echo e(route('admin-childcat-load',$sub->id)); ?>"
                                                            value="<?php echo e($sub->id); ?>" <?php echo e($sub->id == $data->subcategory_id ? "selected":""); ?> ><?php echo e($sub->name); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php endif; ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <select id="childcat"
                                                name="childcategory_id" <?php echo e($data->subcategory_id == null ? "disabled":""); ?>>
                                        ...
                                        <ul class="list">
                                            <li>
                                                <input class="checkclick1" name="shipping_time_check" type="checkbox"
                                                       id="check1" value="1" <?php echo e($data->ship != null ? "checked":""); ?>>
                                        ...
                                        <ul class="list">
                                            <li>
                                                <input name="size_check" type="checkbox" id="size-check"
                                                       value="1" <?php echo e(!empty($data->size) ? "checked":""); ?>>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-4 col-sm-6">
                                                                    ...
                                                                    <input type="number" name="size_qty[]"
                                                                           ...
                                                                           min="1" value="<?php echo e($data->size_qty[$key]); ?>">
                                                                </div>
                                                                <div class="col-md-4 col-sm-6">
                                                                    <label>
                                                                    ...
                                                                    <input type="number" name="size_price[]"
                                                                           class="input-field"
                                                                           placeholder="<?php echo e(__('Size Price')); ?>" min="0"
                                                                           value="<?php echo e($data->size_price[$key]); ?>" step="0.01">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <ul class="list">
                                            <li>
                                                <input class="checkclick1" name="color_check" type="checkbox"
                                                       id="check3" value="1" <?php echo e(!empty($data->color) ? "checked":""); ?>>
                                        ...
                                        <?php $__currentLoopData = $catAttributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $catAttribute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <ul class="list">
                                                        <li>
                                                            <input class="checkclick2" name="<?php echo e($catAttribute->input_name); ?>_check" type="checkbox" id="<?php echo e($catAttribute->input_name); ?>_check" value="1" <?php if($checkattr): ?> checked <?php endif; ?>>
                                                            <label for="<?php echo e($catAttribute->input_name); ?>_check">Allow Product <?php echo e($catAttribute->name); ?></label>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="<?php echo e($checkattr ? "":"showbox"); ?>">
                                            <div class="row">
                                                    <div class="col-lg-4">
                                                        <div class="left-area">
                                                        </div>
                                                    ...
                                                    <div class="col-lg-7">
                                                        ...
                                                        <?php $__currentLoopData = $catAttribute->attribute_options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $optionKey => $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-6 <?php echo e($catAttribute->price_status == 0 ? 'd-none' : ''); ?>">
                                                                    <div class="row">
                                                                            <div class="col-2">
                                                                                +
                                                                            </div>
                                        ...
                                        <?php $__currentLoopData = $subAttributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subAttribute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <ul class="list">
                                                        <li>
                                                            <input class="checkclick2" name="<?php echo e($subAttribute->input_name); ?>_check" type="checkbox" id="<?php echo e($subAttribute->input_name); ?>_check" value="1" <?php if($checkattr): ?> checked <?php endif; ?>>
                                                            <label for="<?php echo e($subAttribute->input_name); ?>_check">Allow Product <?php echo e($subAttribute->name); ?></label>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                            ...
                                                            <?php $__currentLoopData = $subAttribute->attribute_options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                ...
                                                                <div class="col-lg-6 <?php echo e($subAttribute->price_status == 0 ? 'd-none' : ''); ?>">
                                                                    <div class="row">
                                                                        <div class="col-2">
                                                                            +
                                                                        </div>
                                        ...
                                        <?php $__currentLoopData = $childAttributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $childAttribute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <ul class="list">
                                                        <li>
                                                            <input class="checkclick2" name="<?php echo e($childAttribute->input_name); ?>_check" type="checkbox" id="<?php echo e($childAttribute->input_name); ?>_check" value="1" <?php if($checkattr): ?> checked <?php endif; ?>>
                                                            <label for="<?php echo e($childAttribute->input_name); ?>_check">Allow Product <?php echo e($childAttribute->name); ?></label>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="col-lg-7">
                                                        ...
                                                        <?php $__currentLoopData = $childAttribute->attribute_options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $optionKey => $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-6 <?php echo e($childAttribute->price_status == 0 ? 'd-none' : ''); ?>">
                                                                        <div class="row">
                                                                            <div class="col-2">
                                                                                    +
                                                                            </div>
                                        ...
                                        <ul class="list">
                                            <li>
                                                <input class="checkclick1" name="whole_check" type="checkbox"
                                                       id="whole_check"
                                                       value="1" <?php echo e(!empty($data->whole_sell_qty) ? "checked":""); ?>>
                                                <label for="whole_check"><?php echo e(__('Allow Product Wholesale')); ?></label>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <input type="number"
                                                                               ...
                                                                               class="input-field"
                                                                               placeholder="<?php echo e(__('Enter Discount Price')); ?>"
                                                                               min="0"
                                                                               step="0.1"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input name="price" type="number" class="input-field" placeholder="e.g 20"
                                               step="0.01" min="0" value="<?php echo e(round($data->price * $sign->value , 2)); ?>"
                                               required="">
                                    </div>
                                </div>
                                ...
                                <div class="row prod-effect d-none">
                                    ...
                                    <div class="col-lg-7">
                                        <div class="text-editor">
                                            <textarea rows="5" class="form-control" id="effects" name="effects"><?php echo e($data->effects); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <div class="text-editor">
                                            <textarea rows="5" name="details" id="details" class="form-control"><?php echo e($data->details); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <div class="text-editor">
                                            <textarea rows="5" name="policy" id="policy" class="form-control"><?php echo e($data->policy); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row prod-parent d-none">
                                    ...
                                    <div class="col-lg-7">
                                        <div class="text-editor">
                                            <textarea rows="5" class="form-control" name="parent" id="parent"><?php echo e($data->parent); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-7">
                                        ...
                                        <div class="checkbox-wrapper">
                                            <input type="checkbox" name="seo_check" value="1" class="checkclick"
                                                   id="allowProductSEO" <?php echo e(($data->meta_tag != null || strip_tags($data->meta_description) != null) ? 'checked':''); ?>>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-6">
                                                                    <input type="text" name="features[]"
                                                                           <?php if($key==0): ?> id="feature"  <?php endif; ?>
                                                                           class="input-field"
