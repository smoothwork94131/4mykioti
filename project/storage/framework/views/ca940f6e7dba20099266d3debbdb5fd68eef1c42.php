<div id="quick-details" class="row product-details-page py-0">
    <div class="col-lg-5">
        ...
        <div class="xzoom-container">
            ...
            <?php else: ?>
            <img class="quick-zoom" id="xzoom-magnific1"
                 src="<?php echo e(asset('assets/images/products/'.$gs->prod_image)); ?>"
                 xoriginal="<?php echo e(asset('assets/images/products/'.$gs->prod_image)); ?>"/>
            <div class="xzoom-thumbs">

                <div class="quick-all-slider">

                    <a href="<?php echo e(asset('assets/images/products/'.$gs->prod_image)); ?>">
                        <img class="quick-zoom-gallery" width="80"
                             src="<?php echo e(asset('assets/images/products/'.$gs->prod_image)); ?>"
                             title="The description goes here">
                    </a>
        ...
        <div class="right-area">
            <div class="product-info">
                <h4 class="product-name"><a target="_blank"
                                            href="<?php echo e(route('front.iproduct', [
                ...
                <div class="product-price">
                    ...
                    <p class="price"><span id="msizeprice"><?php echo e($product->price); ?></span>
                    </p>
                    ...
                    <div class="mproduct-color">
                        ...
                        <ul class="color-list">
                            ...
                            <?php $__currentLoopData = $product->color; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="<?php echo e($is_first ? 'active' : ''); ?>">
                                    <span class="box" data-color="<?php echo e($product->color[$key]); ?>"
                                          style="background-color: <?php echo e($product->color[$key]); ?>"></span>
                                </li>
                                <?php
                                    $is_first = false;
                                ?>
                ...
                <input type="hidden" id="mdb" value="<?php echo e($db??'products'); ?>">
                ...
                <div class="info-meta-3">
                    <ul class="meta-list">
                                                    ...
                                                    <div class="">
                                                        <?php $__currentLoopData = $attrVal['values']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $optionKey => $optionVal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <div class="custom-control custom-radio">
                                                                ...
                                                                <input type="radio" id="<?php echo e($attrKey); ?><?php echo e($optionKey); ?>"
                                                                ...
                                                                <label class="custom-control-label"
                                                                       for="<?php echo e($attrKey); ?><?php echo e($optionKey); ?>"><?php echo e($optionVal); ?>

                                                                    : <?php echo e($curr->sign); ?> <?php echo e(number_format($product->showRealPrice() + $attrVal['prices'][$optionKey] * $curr->value, '2', '.', '')); ?>
                        ...
                        <?php else: ?>
                            ...
                            <?php else: ?>
                                <li class="addtocart">
                                    <a href="javascript:;" id="maddcrt"><i class="icofont-cart"></i><?php echo e($langg->lang90); ?>
                        ...
                        <?php if(Auth::guard('web')->check()): ?>
                            <li class="favorite">
                                <a href="javascript:;" class="add-to-wish"
                                   data-href="<?php echo e(route('user-wishlist-add',$product->id)); ?>"><i
