                                                    ...
                                                    <div class="row set-account-pass d-none">
                                                        <div class="col-lg-6">
                                                            <input type="password" name="personal_pass"
                                                                   ...
                                                                   placeholder="<?php echo e($langg->lang750); ?>">
                                                        </div>
                                                        <div class="col-lg-6">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input class="form-control" type="text" name="name"
                                                               ...
                                                               value="<?php echo e(Auth::guard('web')->check() ? Auth::guard('web')->user()->name : ''); ?>" <?php echo Auth::check() ? 'readonly' : ''; ?>>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <input class="form-control" type="text" name="phone"
                                                               placeholder="<?php echo e($langg->lang153); ?>" required=""
                                                               value="<?php echo e(Auth::guard('web')->check() ? Auth::guard('web')->user()->phone : ''); ?>" <?php echo Auth::check() ? 'readonly' : ''; ?>>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <input class="form-control" type="text" name="email"
                                                               placeholder="<?php echo e($langg->lang154); ?>" required=""
                                                               value="<?php echo e(Auth::guard('web')->check() ? Auth::guard('web')->user()->email : ''); ?>" <?php echo Auth::check() ? 'readonly' : ''; ?>>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <input class="form-control" type="text" name="address"
                                                               placeholder="<?php echo e($langg->lang155); ?>" required=""
                                                               value="<?php echo e(Auth::guard('web')->check() ? Auth::guard('web')->user()->address : ''); ?>" <?php echo Auth::check() ? 'readonly' : ''; ?>>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <select class="form-control" name="customer_country"
                                                                required="" <?php echo Auth::check() ? 'readonly' : ''; ?>>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input class="form-control" type="text" name="city"
                                                               ...
                                                               value="<?php echo e(Auth::guard('web')->check() ? Auth::guard('web')->user()->city : ''); ?>" <?php echo Auth::check() ? 'readonly' : ''; ?>>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <input class="form-control" type="text" name="zip"
                                                               placeholder="<?php echo e($langg->lang159); ?>" required=""
                                                               value="<?php echo e(Auth::guard('web')->check() ? Auth::guard('web')->user()->zip : ''); ?>" <?php echo Auth::check() ? 'readonly' : ''; ?>>
                                                    </div>
                                                    
                                                </div>
                                            </div>
                                            <div class="row <?php echo e($digital == 1 || !Auth::guard('web')->user() || (!Auth::guard('web')->user()->is_verified)? 'd-none' : ''); ?>">
                                                <div class="col-lg-12 mt-3">
                                    ...
                                    <div class="content-box">
                                        <div class="content">
                                            ...
                                            <div class="order-area">
                                                    ...
                                                    <div class="order-item">
                                                        ...
                                                        <div class="product-content">
                                                            <p class="name"><a
                                                                        ...
                                                                        target="_blank"><?php echo e($product['item']->name); ?></a>
                                                            </p>
                                                            ...
                                                            <?php if(!empty($product['keys'])): ?>
                                                                ...
                                                                <?php $__currentLoopData = array_combine(explode(',', $product['keys']), explode(',', $product['values'])); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    ...
                                                                    <div class="quantity">
                                                                        <h5 class="label"><?php echo e(ucwords(str_replace('_', ' ', $key))); ?>
                                                ...
                                                <?php $__currentLoopData = $productsNw; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="order-item">
                                                        <div class="product-img">
                                                            <div class="d-flex">
                                                                <img src=" <?php echo e(asset('assets/images/products/'.$product['item']->photo)); ?>"
                                        ...
                                        <div class="content">
                                            ...
                                            <div class="payment-information">
                                                ...
                                                <a class="nav-link payment" data-val=""
                                                                       data-show="no"
                                                                       data-form="<?php echo e(route('front.checkout.shopify')); ?>"
                                                                       data-href="<?php echo e(route('front.checkout.shopify')); ?>"
                                                ...
                                                <a class="nav-link payment"
                                                                       id="addtotemp"
                                                                       data-form="<?php echo e(route('front.checkout.addtemp')); ?>"
                                                                       ></a>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="nav flex-column" role="tablist"
                                                            ...
                                                            <?php endif; ?>
                                                            <?php if($gs->cod_check == 2 && Auth::check()): ?>
                                                                <?php
                                                                    $cod = true;
                                                                ?>
                                                                <?php if($cod): ?>
                                                            ...
                                                            <?php endif; ?>
                                                            <?php if($gs->is_paytm == 2): ?>
                                                                <a class="nav-link payment" data-val="" data-show="no"
                                                                   data-form="<?php echo e(route('paytm.submit')); ?>"
                                                                   data-href="<?php echo e(route('front.load.payment',['slug1' => 'paytm','slug2' => 0])); ?>"
                                                            ...
                                                            <?php endif; ?>
                                                            <?php if($gs->is_razorpay == 2): ?>
                                                                <a class="nav-link payment" data-val="" data-show="no"
                                                                   data-form="<?php echo e(route('razorpay.submit')); ?>"
                                                                   data-href="<?php echo e(route('front.load.payment',['slug1' => 'razorpay','slug2' => 0])); ?>"
                                                            ...
                                                            <?php if($gs->is_molly == 2): ?>
                                                                <a class="nav-link payment" data-val="" data-show="no"
                                                                   data-form="<?php echo e(route('molly.submit')); ?>"
                                                                   data-href="<?php echo e(route('front.load.payment',['slug1' => 'molly','slug2' => 0])); ?>"
                                                            ...
                                                            <?php if($digital == 2): ?>
                                                                ...
                                                                <?php $__currentLoopData = $gateways; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    ...
                                                                    <a class="nav-link payment" data-val=""
                                                                       ...
                                                                       id="v-pills-tab<?php echo e($gt->id); ?>-tab"
                                                                       data-toggle="pill"
                                                                ...
                                                                <?php if($digital == 2): ?>
                                                                    <?php $__currentLoopData = $gateways; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        ...
                                                                        <div class="tab-pane fade"
                                                                             id="v-pills-tab<?php echo e($gt->id); ?>"
                                                                             role="tabpanel"
                                                ...
                                                <div class="col-lg-12 mt-3">
                                                    <div class="bottom-area">
                                                        ...
                                                        <a href="javascript:;" id="step2-btn"
                                                           class="mybtn1 mr-3 mt-1"><?php echo e($langg->lang757); ?></a>
                                                           
                                                        <?php if($productsNw): ?>
                                                        <a href="<?php echo e(route('front.cart.clear')); ?>"
                                ...
                                <?php if($digital == 0): ?>
                                    ...
                                    <!-- <div class="packeging-area">
                                        <h4 class="title"><?php echo e($langg->lang765); ?></h4>
                                            <div class="radio-design">
                                                <input type="radio" class="shipping" id="free-shepping"
                                                       name="shipping"
                                                       value="<?php echo e($shipping_price); ?>" checked>
                                                <span class="checkmark"></span>
                                                <label for="free-shepping">
                                                    Shipping $<?php echo e($shipping_price); ?> 
                                        ...
                                        <?php $__currentLoopData = $shipping_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="radio-design">
                                                <input type="radio" class="shipping" id="free-shepping<?php echo e($data->id); ?>"
                                                       name="shipping"
                                                       value="<?php echo e(round($data->price * $curr->value,2)); ?>" <?php echo e(($loop->first) ? 'checked' : ''); ?>>
                                                <span class="checkmark"></span>
                                    ...
                                    <div class="packeging-area">
                                        ...
                                        <?php $__currentLoopData = $package_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="radio-design">
                                                <input type="radio" class="packing" id="free-package<?php echo e($data->id); ?>"
                                                       name="packeging"
                                                       value="<?php echo e(round($data->price * $curr->value,2)); ?>" <?php echo e(($loop->first) ? 'checked' : ''); ?>>
                                                <span class="checkmark"></span>
                            ...
                            <div class="tab-pane fade" id="nav-reg" role="tabpanel" aria-labelledby="nav-reg-tab">
                                <div class="login-area signup-area">
                                    ...
                                    <div class="login-form signup-form">
                                        <?php echo $__env->make('includes.admin.form-login', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                        <form id="registerform" action="<?php echo e(route('user-register-submit')); ?>"
                                              method="POST">
                                            <?php echo e(csrf_field()); ?>
                                                ...
                                                <ul class="captcha-area">
                                                    <li>
                                                        <p><img class="codeimg1"
                                                                src="<?php echo e(asset("assets/images/capcha_code.png")); ?>" alt="">
