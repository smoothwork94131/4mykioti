            ...
            <?php $__currentLoopData = $productt->comments()->orderBy('created_at','desc')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li>
                    <div class="single-comment comment-section">
                        <div class="left-area">
                            <img src="<?php echo e($comment->user->photo != null ? asset('assets/images/users/'.$comment->user->photo) : asset('assets/images/noimage.png')); ?>"
                                 alt="">
                                ...
                                <div class="links">
                                    ...
                                    <?php if(count($comment->replies) > 0): ?>
                                        <a href="javascript:;" class="comment-link view-reply mr-2"><i
                                                    class="fas fa-eye "></i><?php echo e($langg->lang108); ?> <?php echo e(count($comment->replies) == 1 ? $langg->lang109 : $langg->lang110); ?>
                                    ...
                                    <?php if(Auth::guard('web')->user()->id == $comment->user->id): ?>
                                        ...
                                        <a href="javascript:;"
                                           data-href="<?php echo e(route('product.comment.delete',$comment->id)); ?>"
                                           class="comment-link comment-delete mr-2"><i
                                                    class="fas fa-trash"></i><?php echo e($langg->lang112); ?></a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                    ...
                    <?php if($comment->replies): ?>
                        <?php $__currentLoopData = $comment->replies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reply): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="single-comment replay-review hidden">
                                <div class="left-area">
                                    <img src="<?php echo e($reply->user->photo != null ? asset('assets/images/users/'.$reply->user->photo) : asset('assets/images/noimage.png')); ?>"
                                         alt="">
                                        ...
                                        <div class="links">
                                            ...
                                            <?php if(Auth::guard('web')->user()->id == $reply->user->id): ?>
                                                <a href="javascript:;" class="comment-link edit mr-2"><i
                                                            class="fas fa-edit "></i><?php echo e($langg->lang111); ?></a>
                                                <a href="javascript:;"
                                                   data-href="<?php echo e(route('product.reply.delete',$reply->id)); ?>"
                            ...
                            <div class="replay-area edit-area">
                                <form class="update" action="<?php echo e(route('product.reply.edit',$reply->id)); ?>"
                                      method="POST">
                                    <?php echo e(csrf_field()); ?>
