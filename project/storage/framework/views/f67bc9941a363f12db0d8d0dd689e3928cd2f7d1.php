                    ...
                    <div class="heading-area">
                        ...
                        <div class="action-list">
                            <select class="process select droplinks <?php echo e($gs->multiple_shipping == 1 ? 'drop-success' : 'drop-danger'); ?>">
                                <option data-val="1"
                                        value="<?php echo e(route('admin-gs-mship',1)); ?>" <?php echo e($gs->multiple_shipping == 1 ? 'selected' : ''); ?>><?php echo e(__('Activated')); ?></option>
                                <option data-val="0"
                                        value="<?php echo e(route('admin-gs-mship',0)); ?>" <?php echo e($gs->multiple_shipping == 0 ? 'selected' : ''); ?>><?php echo e(__('Deactivated')); ?></option>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="table-responsiv">
                            <table id="geniustable" class="table table-hover dt-responsive" cellspacing="0"
                                ...
                                <tr>
                                    ...
                                    <th><?php echo e(__('Trigger Price')); ?></th>
