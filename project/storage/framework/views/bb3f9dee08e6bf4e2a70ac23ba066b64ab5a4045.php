<?php $__env->startSection('content'); ?>
    ...
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading"><?php echo e(__('Home Product View')); ?> </h4>
                    <ul class="links">
                        <li>
                        ...
                        <li>
                            <a href="<?php echo e(route('admin-productview-home')); ?>"><?php echo e(__('Home Product View')); ?> </a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="product-description">
                        <div class="body-area">
                            ...
                            <form id="geniusform" action="<?php echo e(route('admin-productview-home-store')); ?>" method="POST">
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="prod-style-title" style="display:flex; align-items: center; justify-content: space-between">
                                            <div class="form-group">
                                                ...
                                                <input type="radio" name="productview" id="productview-1" value="0" <?php if(json_decode($gs->product_view)->home == 0): ?> checked <?php endif; ?>>
                                            </div>
                                            <div class="form-group">
                                                <a href="<?php echo e(route('admin-productview-color', array('type' => 1, 'style_id' => 1))); ?>" class="add-btn">
                                        ...
                                        <div class="item">
                                            <div class="item-img">
                                                <div class="sell-area">
                                                    <span class="sale" style="background-color:<?php echo e($colorsetting_style1 && $colorsetting_style1->tag_bg_color? $colorsetting_style1->tag_bg_color: '#000000'); ?>; color: <?php echo e($colorsetting_style1 && $colorsetting_style1->tag_color? $colorsetting_style1->tag_color: '#ffffff'); ?>">CK20</span>
                                                </div>
                                                ...
                                                <img class="img-fluid" src="<?php echo e(asset('assets/images/thumbnails/T2185-00101.JPG')); ?>" alt="">
                                            </div>
                                            <div class="info">
                                                <div class="stars">
                                                    <div class="ratings">
                                                ...
                                                <h4 class="price" style="color: <?php echo e($colorsetting_style1 && $colorsetting_style1->price_color? $colorsetting_style1->price_color : '#333333'); ?>">$4.16
                                                    <del><small></small></del>
                                                </h4>
                                                <h5 class="name" style="color: <?php echo e($colorsetting_style1 && $colorsetting_style1->title_color? $colorsetting_style1->title_color: '#333333'); ?>">BULB v</h5>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="prod-style-title" style="display:flex; align-items: center; justify-content: space-between">
                                            <div class="form-group">
                                                ...
                                                <input type="radio" name="productview" id="productview-2" value="1" <?php if(json_decode($gs->product_view)->home == 1): ?> checked <?php endif; ?>>
                                            </div>
                                            <div class="form-group">
                                                <a href="<?php echo e(route('admin-productview-color', array('type' => 1, 'style_id' => 2))); ?>" class="add-btn">
                                                    <i class="fas fa-edit"></i> 
                                                    <span class="remove-mobile">
                                                        Color Setting<span></span>
                                                    </span>
                                        ...
                                        <a href="#" class="prod-item item">            
                                            <div class="prod-init">
                                                <div class="prod-top">
                                                    <h2 class="prod-name" style="color: <?php echo e($colorsetting_style2 && $colorsetting_style2->title_color? $colorsetting_style2->title_color: '#333333'); ?>">BULB v</h2>
                                                </div> 
                                                
                                                <p class="prod-tag">
                                                    <span class="sale" style="background-color: <?php echo e($colorsetting_style2 && $colorsetting_style2->tag_bg_color? $colorsetting_style2->tag_bg_color : '#84a45a'); ?>; color: <?php echo e($colorsetting_style2 && $colorsetting_style2->tag_color? $colorsetting_style2->tag_color: '#000000'); ?>">CK20</span>
                                                </p>
                                            ...
                                            <img class="prod-image" src="<?php echo e(asset('assets/images/thumbnails/T2185-00101.JPG')); ?>" alt="">
                                        </a>
                                    </div>
                                </div>
