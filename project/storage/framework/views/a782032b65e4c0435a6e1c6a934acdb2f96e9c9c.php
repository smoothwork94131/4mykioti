                                ...
                                <div class="dropdown-menu">
                                    <div class="dropdownmenu-wrapper">
                                        <ul>
                                            ...
                                            <li>
                                                <a href="<?php echo e(route('admin.profile')); ?>"><i
                                                            class="fas fa-user"></i> <?php echo e(__('Edit Profile')); ?></a>
                                            </li>
                                            <li>
                                                <a href="<?php echo e(route('admin.password')); ?>"><i
                                                            class="fas fa-cog"></i> <?php echo e(__('Change Password')); ?></a>
                                            </li>
                                            <li>
...
<script type="text/javascript">
    ...
    var whole_sell = <?php echo e($gs->wholesale); ?>;
...
<script src="<?php echo e(asset('assets/admin/js/bootstrap-datepicker.js')); ?>"></script>
