<?php $__env->startSection('content'); ?>
    ...
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading"><?php echo e(__('Category/Search Product View')); ?> </h4>
                    <ul class="links">
                        <li>
                        ...
                        <li>
                            <a href="<?php echo e(route('admin-productview-filtered')); ?>"><?php echo e(__('Category/Search View')); ?> </a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="product-description">
                        <div class="body-area">
                            ...
                            <form id="geniusform" action="<?php echo e(route('admin-productview-filtered-store')); ?>" method="POST">
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="prod-style-title" style="display:flex; align-items: center; justify-content: space-between">
                                            <div class="form-group">
                                                ...
                                                <input type="radio" name="productview" id="productview-1" value="0" <?php if(json_decode($gs->product_view)->filtered == 0): ?> checked <?php endif; ?>>
                                            </div>
                                            <div class="form-group">
                                                <a href="<?php echo e(route('admin-productview-color', array('type' => 2, 'style_id' => 1))); ?>" class="add-btn">
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="prod-style-title" style="display:flex; align-items: center; justify-content: space-between">
                                            <div class="form-group">
                                                ...
                                                <input type="radio" name="productview" id="productview-2" value="1" <?php if(json_decode($gs->product_view)->filtered == 1): ?> checked <?php endif; ?>>
                                            </div>
                                            <div class="form-group">
                                                <a href="<?php echo e(route('admin-productview-color', array('type' => 2, 'style_id' => 2))); ?>" class="add-btn">
                                                    <i class="fas fa-edit"></i> 
                                                    <span class="remove-mobile">
                                                        Color Setting<span></span>
                                                    </span>
