                        ...
                        <div class="body-area">
                            ...
                            <form id="geniusform" action="<?php echo e(route('admin-gs-update')); ?>" method="POST"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="action-list">
                                            <select class="process select droplinks <?php echo e($gs->is_maintain  == 1 ? 'drop-success' : 'drop-danger'); ?>">
                                                <option data-val="1"
                                                        value="<?php echo e(route('admin-gs-maintain',1)); ?>" <?php echo e($gs->is_maintain == 1 ? 'selected' : ''); ?>><?php echo e(__('Activated')); ?></option>
                                                <option data-val="0"
                                                        value="<?php echo e(route('admin-gs-maintain',0)); ?>" <?php echo e($gs->is_maintain == 0 ? 'selected' : ''); ?>><?php echo e(__('Deactivated')); ?></option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="tawk-area">
                                            <textarea class="nic-edit" name="maintain_text"
                                                      required=""><?php echo e($gs->maintain_text); ?></textarea>
                                        </div>
                                    </div>
                                </div>
