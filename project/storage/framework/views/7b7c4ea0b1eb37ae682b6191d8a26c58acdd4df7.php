<?php $__env->startSection('content'); ?>
    <input type="hidden" id="headerdata" value="<?php echo e(__('EMAIL TEMPLATES')); ?>">
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading"><?php echo e(__('Email Templates')); ?></h4>
                    <ul class="links">
                        <li>
                        ...
                        <li>
                            <a href="<?php echo e(route('admin-mail-index')); ?>"><?php echo e(__('Email Templates')); ?></a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="modal fade" id="confirm-delete" tabindex="-1" role="dialog" aria-labelledby="modal1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <!-- Modal body -->
                <div class="modal-body">
                    <p class="text-center"><?php echo e(__('You are about to delete this Email. Everything will be deleted under this Email.')); ?></p>
