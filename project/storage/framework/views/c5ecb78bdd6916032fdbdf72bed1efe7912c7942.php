...
<div class="col-lg-4">
    <div class="user-profile-info-area">
        <ul class="links">
            ...
            <?php if(Auth::user()): ?>
                <li class="<?php echo e($link == route('user-verified-index') ? 'active':''); ?>">
                    <?php
                    ...
                    <?php if($flag > 0): ?>
                        <a href="javascript:void(0)">
                            ...
                            Verified Until <?php echo e(date("F j, Y", strtotime($exprire_date))); ?>

                        </a>
                    <?php else: ?>
                        <a href="<?php echo e(route('user-verified-index')); ?>">
                            Get Verified
                        </a>
                    <?php endif; ?>
                </li>
